...
"[project]/components/subscription/subscriptionPage.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SubscriptionPlan() {
    ...
    const { user, loading: authLoading, token } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$authContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const [selectedBillingPeriod, setSelectedBillingPeriod] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('MONTHLY');
    ...
    const [esewaFormData, setEsewaFormData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [esewaPaymentUrl, setEsewaPaymentUrl] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [trialUsed, setTrialUsed] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [loadingTrialStatus, setLoadingTrialStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const esewaFormRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    // Check URL params for payment status
    const status = searchParams.get('status');
    const message = searchParams.get('message');
    const fromSetup = searchParams.get('from') === 'setup';
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SubscriptionPlan.useEffect": ()=>{
            if (status === 'success') {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(message || 'Payment successful! Your subscription is now active.');
                // Redirect to dashboard after payment success
                const redirectTimer = setTimeout({
                    "SubscriptionPlan.useEffect.redirectTimer": ()=>{
                        router.push('/dashboard');
                    }
                }["SubscriptionPlan.useEffect.redirectTimer"], 2000);
                return ({
                    "SubscriptionPlan.useEffect": ()=>clearTimeout(redirectTimer)
                })["SubscriptionPlan.useEffect"];
            } else if (status === 'failed') {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(message || 'Payment failed. Please try again.');
            } else if (status === 'error') {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(message || 'An error occurred during payment.');
            }
        }
    }["SubscriptionPlan.useEffect"], [
        status,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SubscriptionPlan.useEffect": ()=>{
            const checkTrialStatus = {
                "SubscriptionPlan.useEffect.checkTrialStatus": async ()=>{
                    try {
            ...
            }["SubscriptionPlan.useEffect.checkTrialStatus"];
            checkTrialStatus();
        }
    }["SubscriptionPlan.useEffect"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SubscriptionPlan.useEffect": ()=>{
            const fetchPlans = {
                "SubscriptionPlan.useEffect.fetchPlans": async ()=>{
                    try {
                        const API_URL = ("TURBOPACK compile-time value", "http://localhost:5001") || 'http://localhost:5001';
                        console.log('[v0] Fetching subscription plans from:', `${API_URL}/api/subscription-payment/plans`);
                        const controller = new AbortController();
                        const timeout = setTimeout({
                            "SubscriptionPlan.useEffect.fetchPlans.timeout": ()=>controller.abort()
                        }["SubscriptionPlan.useEffect.fetchPlans.timeout"], 10000) // 10 second timeout
                        ;
                            ...
                            if (response.status === 404 || response.status === 500) {
                                ...
                                try {
                                    ...
                                    const seedData = await seedResponse.json().catch({
                                        "SubscriptionPlan.useEffect.fetchPlans": ()=>({
                                    ...
                                    if (seedResponse.ok && seedData.plans) {
                                        ...
                                        await new Promise({
                                            "SubscriptionPlan.useEffect.fetchPlans": (resolve)=>setTimeout(resolve, 1000)
                                        }["SubscriptionPlan.useEffect.fetchPlans"]);
                                        ...
                                        if (retryResponse.ok) {
                                            ...
                                            const sortedPlans = (data.plans || []).sort({
                                                "SubscriptionPlan.useEffect.fetchPlans.sortedPlans": (a, b)=>a.priceNPR - b.priceNPR
                                            }["SubscriptionPlan.useEffect.fetchPlans.sortedPlans"]).map({
                                                "SubscriptionPlan.useEffect.fetchPlans.sortedPlans": (plan, index)=>({
                                                        ...plan,
                                                        recommended: index === 1
                                                    })
                                            }["SubscriptionPlan.useEffect.fetchPlans.sortedPlans"]);
                            ...
                            try {
                                ...
                                if (seedResponse.ok && seedData.plans) {
                                    ...
                                    if (retryResponse.ok) {
                                        ...
                                        const sortedPlans = (retryData.plans || []).sort({
                                            "SubscriptionPlan.useEffect.fetchPlans.sortedPlans": (a, b)=>a.priceNPR - b.priceNPR
                                        }["SubscriptionPlan.useEffect.fetchPlans.sortedPlans"]).map({
                                            "SubscriptionPlan.useEffect.fetchPlans.sortedPlans": (plan, index)=>({
                                                    ...plan,
                        ...
                        if (error.name !== 'AbortError') {
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Failed to load subscription plans');
                        }
    ...
    const handleStartTrial = async (planId, billingPeriod)=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`${plan.displayName || plan.name} trial activated! You have 15 days free access.`);
            router.push('/dashboard');
        } catch (error) {
    ...
    const handleEsewaPayment = async (planId, billingPeriod)=>{
        ...
        try {
            ...
            if (data.success && data.formData && data.paymentUrl) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].info('Redirecting to eSewa...');
            } else {
                throw new Error('Invalid payment response');
            }
        } catch (error) {
            console.error('[v0] eSewa payment error:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(error.message || 'Failed to initiate payment');
            setIsLoading(false);
        }
    };
    const formatLimit = (limit)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                        ...
                        children: plans.map((plan)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                            ...
                                            children: [
                                                ...
                                                plan.allowReports && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                    className: "flex items-start gap-2 text-sm",
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: "text-primary font-bold mt-0.5",
                                                ...
                                                plan.prioritySupport && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                    className: "flex items-start gap-2 text-sm",
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: "text-primary font-bold mt-0.5",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "space-y-3",
                                        children: [
                                            trialUsed ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            esewaFormData && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                ref: esewaFormRef,
...
_s(SubscriptionPlan, "+8QZMkOzp+09PDg95SptMx6kcf8=", false, function() {
    return [
...
_c = SubscriptionPlan;
var _c;
__turbopack_context__.k.register(_c, "SubscriptionPlan");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=components_2a8931f8._.js.map