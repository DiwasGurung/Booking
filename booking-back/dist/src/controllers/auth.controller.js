    ...
    googleOAuth(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const tokenInfo = yield googleClient.getTokenInfo(access_token);
                if (!tokenInfo.email) {
                ...
                let user = yield user_service_1.userService.findByGoogleId(googleId);
                if (!user) {
                    // Check if user exists by email
                    const existingUser = yield user_service_1.userService.findByEmail(email);
                    if (existingUser) {
                        // Link Google to existing user
                        user = yield user_service_1.userService.linkGoogleToUser(existingUser.id, googleId);
                ...
                res.json({
                    ...
                    user: {
                        ...
                        businessId: (_a = user.business) === null || _a === void 0 ? void 0 : _a.id,
                    },
                });
            }
            catch (error) {
