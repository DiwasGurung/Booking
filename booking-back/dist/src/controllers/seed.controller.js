    ...
    seedPlans(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const existingPlans = yield prisma_1.default.subscriptionPlan.findMany();
                ...
                const createdPlans = yield Promise.all(plans.map((plan) => prisma_1.default.subscriptionPlan.create({
                    data: plan,
                })));
