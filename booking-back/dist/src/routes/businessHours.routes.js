...
businessHoursRoutes.post("/:businessId/closed-dates", auth_middleware_1.auth, businessHours_controller_1.default.addClosedDate);
businessHoursRoutes.get("/:businessId/closed-dates", businessHours_controller_1.default.getClosedDates);
businessHoursRoutes.delete("/:businessId/closed-dates/:dateId", auth_middleware_1.auth, businessHours_controller_1.default.removeClosedDate);
// Time Off Routes
businessHoursRoutes.post("/:businessId/time-off", auth_middleware_1.auth, businessHours_controller_1.default.addTimeOff);
businessHoursRoutes.get("/:businessId/time-off", businessHours_controller_1.default.getTimeOffs);
businessHoursRoutes.delete("/time-off/:timeOffId", auth_middleware_1.auth, businessHours_controller_1.default.removeTimeOff);
