 ...
 */
router.patch("/bookings/:bookingId/status", staff_controller_1.updateBookingStatus);
/**
...
router.get("/:staffId/performance", auth_middleware_1.auth, staff_controller_1.getStaffPerformance);
router.get("/:staffId/stats", auth_middleware_1.auth, staff_controller_1.getStaffStats);
