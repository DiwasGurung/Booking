 ...
 */
router.post("/", auth_middleware_js_1.auth, staff_controller_js_1.createStaff);
/**
 * @route GET /api/staff/:id
 * @desc Get staff by ID
 * @access Public
 */
router.get("/:id", staff_controller_js_1.getStaffById);
/**
 * @route GET /api/staff/business/:businessId
 * @desc Get all staff for a business
 * @access Public
 */
router.get("/business/:businessId", staff_controller_js_1.getBusinessStaff);
/**
 * @route GET /api/staff/service/:serviceId
 * @desc Get staff who can perform a specific service
 * @access Public
 */
router.get("/service/:serviceId", staff_controller_js_1.getStaffForService);
/**
 * @route PUT /api/staff/:id
 * @desc Update staff member
 * @access Private (Business Owner)
 */
router.put("/:id", auth_middleware_js_1.auth, staff_controller_js_1.updateStaff);
/**
 * @route DELETE /api/staff/:id
 * @desc Delete staff member
 * @access Private (Business Owner)
 */
router.delete("/:id", auth_middleware_js_1.auth, staff_controller_js_1.deleteStaff);
/**
 * @route PATCH /api/staff/:id/toggle-status
 * @desc Toggle staff active status
 * @access Private (Business Owner)
 */
router.patch("/:id/toggle-status", auth_middleware_js_1.auth, staff_controller_js_1.toggleStaffStatus);
/**
 * @route GET /api/staff/:staffId/availability
 * @desc Get staff availability for a specific date
 * @access Public
 */
router.get("/:staffId/availability", staff_controller_js_1.getStaffAvailability);
/**
 ...
 * @access Public
 */
router.get("/code/:staffCode", staff_controller_js_1.getStaffByCode);
/**
 * @route GET /api/staff/code/:staffCode/bookings
 * @desc Get staff bookings by staffCode (public)
 * @access Public
 */
router.get("/code/:staffCode/bookings", staff_controller_js_1.getStaffBookings);
/**
 * @route GET /api/staff/:staffId/time-off
 * @desc Get time off for a staff member
 * @access Public
 */
router.get("/:staffId/time-off", staff_controller_js_1.getTimeOff);
/**
