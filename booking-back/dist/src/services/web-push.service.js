...
class WebPushService {
     ...
     */
    static async sendBulkPushNotifications(subscriptions, payload) {
        let success = 0;
        let failed = 0;
     ...
     */
    static async sendBookingConfirmationPush(subscription, bookingData) {
     ...
     */
    static async sendAppointmentReminderPush(subscription, reminderData) {
        return this.sendPushNotification(subscription, {
     ...
     */
    static async sendBookingCancellationPush(subscription, cancellationData) {
        return this.sendPushNotification(subscription, {
