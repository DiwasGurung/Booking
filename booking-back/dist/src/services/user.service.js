...
exports.userService = {
    ...
    // Delete user
    async deleteUser(id) {
        return prisma_js_1.default.user.delete({
            where: { id },
        });
    },
    ...
    async requestPasswordReset(email) {
        const user = await prisma_js_1.default.user.findUnique({ where: { email: email.toLowerCase() } });
        ...
        await email_service_js_1.emailService.sendPasswordResetEmail(user.email, resetToken, 'business');
        return { message };
    },
