...
async function seedSubscriptionPlans() {
    try {
        ...
        const starterPlan = await prisma_1.default.subscriptionPlan.create({
            data: {
                name: 'starter',
                displayName: 'Starter',
                priceNPR: 499,
        ...
        const professionalPlan = await prisma_1.default.subscriptionPlan.create({
            data: {
                name: 'professional',
        ...
        const enterprisePlan = await prisma_1.default.subscriptionPlan.create({
            data: {
                name: 'enterprise',
